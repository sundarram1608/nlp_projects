...
nb_path = find_notebook('textclassification')
loader = NotebookLoader(nb_path)
nb_module = loader.load_module('textclassification')

create_tfidfvectorizer = nb_module.create_tfidfvectorizer
run_vectorizer = nb_module.run_vectorizer
create_model = nb_module.create_model
run_model = nb_module.run_model
create_balanced_model = nb_module.create_balanced_model
create_column_transformer = nb_module.create_column_transformer
